      ...
      <div className="container mx-auto px-4">
        ...
        >
          <a
            ...
            className="inline-flex items-center bg-[#FF0054] hover:bg-[#9E0059]/90 relative text-white font-bold py-3 px-8 rounded-full transition-all duration-300 transform hover:scale-105"
          >
